    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_image', models.ImageField(upload_to='source')),
                ('thumbnail_200px', models.ImageField(blank=True, null=True, upload_to='200px')),
                ('thumbnail_400px', models.ImageField(blank=True, null=True, upload_to='400px')),
